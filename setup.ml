...
(* OASIS_START *)
(* DO NOT EDIT (digest: 708a4e853f9c1237ccf541a8e986bc5e) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/mirleft/ocaml-x509";
          synopsis = "X509 support for OCaml";
          description = Some [OASISText.Para "X509 support for OCaml"];
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Certificate"; "Parser"; "Authenticator"];
                      lib_pack = true;
                      lib_internal_modules =
                        ["X509_common"; "Registry"; "Asn_grammars"];
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Regression"; "X509tests"; "Unittests"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [InternalLibrary "x509"; InternalLibrary "tests"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\1790=0\031\218&\tpr{\219\169x\227T";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
